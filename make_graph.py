...
def compare_height(df, col_name_all, loop_type, legend):
    base_label = "height500_" + loop_type
...
def compare_old_new_equipment(df, col_name_all, legend):
    base_old = "height500_looptype1"
    current_equipment = "height4_looptype1"
    base_new = "height500_looptype3"
...
if __name__=="__main__":
    ...
    # col_name_all = col_name_list.sort()
    # print(type(col_name_all))
